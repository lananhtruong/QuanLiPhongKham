...
namespace QLPKDK.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address,Phone,Email,UserId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address,Phone,Email,UserId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
