...
namespace QLPKDK.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        QLPKDKEntities1 db = new QLPKDKEntities1();
        ...
        {
            List<string> positions = new List<string> { "Director", "Manager", "Secretary", "Employee", "Trainee" };
            ViewBag.Positions = new SelectList(positions, "Employee");
            ViewBag.Roles = new SelectList(db.AspNetRoles.Where(u => !u.Name.Contains("Admin")).ToList(), "Name", "Name");
            return View();
        }
