...
$(document).ready(function () {
    ...
    //slice-guongmat-home - owl-carousel 
    $('#slice-guongmat-home').owlCarousel({
        items: 1,
        lazyLoad: true,
        navigation: true,
        loop: true,
    ...
    //cover-gioithieu - owl-carousel 
    $('#cover-gioithieu').owlCarousel({
        items: 1,
        lazyLoad: true,
        navigation: true,
        loop: true,
    ...
    //slice-newshome - owl-carousel 
    $('#slider-bacsicungkhoa').owlCarousel({
        items: 4,
        lazyLoad: true,
        navigation: true,
        loop: true,
    ...
    //js li- danh sach bac si
    $('.list-bskhoa-content >ul >li').matchHeight();
});
